...
ARG VITE_EXTRA_CHATBOTS_ADDON
ARG VITE_EXTRA_TEAM_MEMBER_ADDON

# Set environment variables from build args
ENV VITE_NODE_ENV=$VITE_NODE_ENV
ENV VITE_EXTRA_TEAM_MEMBER_ADDON=$VITE_EXTRA_TEAM_MEMBER_ADDON
ENV VITE_EXTRA_CHATBOTS_ADDON=$VITE_EXTRA_CHATBOTS_ADDON
