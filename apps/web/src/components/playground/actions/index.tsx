          ...
          {botActions.map((action) => {
            ...
            return (
              <motion.div
                key={action.id}
                className={cn(
                  "group w-full max-w-[300px] bg-white rounded-2xl border-2 border-purple-50 shadow-sm hover:shadow-md transition-all duration-200 overflow-visible relative",
                  !isActive && "opacity-50",
                )}
              >
                <div className="p-6">
